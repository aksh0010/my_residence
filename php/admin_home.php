...
<body>
  <div class='container'>
    ...
    <br>
    <button class="btn btn-info" style="text-decoration:none"> <a href="update_staff.html">Update Staff</a> </button>
    <br><button class="btn btn-warning" style="text-decoration:none"> <a href="student_signup.html">Register Student</a> </button>
    <br>
    <button class="btn btn-info" style="text-decoration:none"> <a href="update_student.html">Update Student</a> </button>

    <br><button class="btn btn-warning" style="text-decoration:none"> <a href="advisor_signup.html">Register Advisor</a> </button>

    <br><button class="btn btn-dark" style="text-decoration:none"> <a href="delete_homepage.html">Delete Data</a> </button>
